...
import (
	"fmt"
	"github.com/Uallessonivo/codepix/application/factory"
	appmodel "github.com/Uallessonivo/codepix/application/model"
...
func (k *KafkaProcessor) processMessage(msg *ckafka.Message) {
	...
	default:
		fmt.Println("Unknown topic:", string(msg.Value))
	}
}
...
func (k *KafkaProcessor) processTransaction(msg *ckafka.Message) error {
	...
	if err != nil {
		fmt.Println("Error on register transaction:", err)
		return err
	}
